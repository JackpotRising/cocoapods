...
SWIFT_CLASS("_TtC13JackpotRising14DateTimePicker")
...
@interface DateTimePicker (SWIFT_EXTENSION(JackpotRising)) <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
@interface DateTimePicker (SWIFT_EXTENSION(JackpotRising)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
@interface JackpotRising (SWIFT_EXTENSION(JackpotRising)) <CLLocationManagerDelegate>
...
- (void)showSDK;
/// Method to fetch current active contests
- (void)getContestStatusWithCompletionHandler:(void (^ _Nonnull)(enum JackpotRisingContestMode))completionHandler;
...
@interface NSNumber (SWIFT_EXTENSION(JackpotRising))
@end
...
SWIFT_CLASS("_TtC13JackpotRising15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(JackpotRising)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(JackpotRising)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(JackpotRising)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC13JackpotRising12TaskDelegate")
...
@interface UITextField (SWIFT_EXTENSION(JackpotRising))
@end


@interface UIView (SWIFT_EXTENSION(JackpotRising))
@end


@interface NSURLSession (SWIFT_EXTENSION(JackpotRising))
@end
