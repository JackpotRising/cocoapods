...
typedef SWIFT_ENUM(NSInteger, JackpotRisingContestMode, closed) {
...
typedef SWIFT_ENUM(NSInteger, JackpotRisingURL, closed) {
  JackpotRisingURLProduction = 0,
  JackpotRisingURLStaging = 1,
};

typedef SWIFT_ENUM(NSInteger, JackpotRisingAPIMode, closed) {
