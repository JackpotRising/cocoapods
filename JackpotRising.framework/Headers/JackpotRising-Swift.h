...
@interface UIBarButtonItem (SWIFT_EXTENSION(JackpotRising))
@end
...
@interface UIImage (SWIFT_EXTENSION(JackpotRising))
@end
...
@interface UIToolbar (SWIFT_EXTENSION(JackpotRising))
@end
...
@interface UIViewController (SWIFT_EXTENSION(JackpotRising))
@end


@interface UIWindow (SWIFT_EXTENSION(JackpotRising))
@end
